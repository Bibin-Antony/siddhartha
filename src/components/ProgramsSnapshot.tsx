      ...
      <div className="container-wide">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {programs.map((program, index) => (
            <div 
              key={index} 
              className="card reveal bg-white border border-gray-100 hover:border-emerald-200"
              style={{animationDelay: `${index * 0.1}s`}}
            >
              <div className="flex items-center justify-center mb-4">
                <div className="bg-emerald-50 p-4 rounded-full hover:bg-emerald-100 transition-colors duration-300">
              ...
              <div className="mt-auto text-center">
                <Button variant="link" className="text-emerald-700 hover:text-emerald-800 group">
                  Learn More 
