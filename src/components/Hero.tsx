      ...
      <div className="container-wide relative z-10 pt-24">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="text-white reveal">
            <div className="inline-block mb-3 px-4 py-1.5 bg-emerald-600/30 rounded-full border border-emerald-500/30">
            ...
            <h1 className="text-white text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              Empowering <PencilUnderline color="bg-emerald-400">Future Doctors</PencilUnderline>
            </h1>
            ...
            <div className="mt-12 grid grid-cols-2 sm:grid-cols-3 gap-6 max-w-lg">
              <div className="bg-emerald-600/30 p-4 rounded-lg border border-emerald-500/30">
